...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2025 at 04:42 PM
...
('USR001', 1, 'John Walker', 'john.walker@example.com', 'student'),
('USR002', 2, 'Walter White', 'walter.white@example.com', 'instructor'),
('USR003', 3, 'Charles Xavier', 'charles.xavier@example.com', 'administrator'),
('USR004', 4, 'Diddy Combs', 'diddy.combs@example.com', 'itofficer'),
('USR005', 5, 'Kevin Hart', 'kevin.hart@example.com', 'financeofficer'),
('USR006', 2, 'Emily Davis', 'emily.davis@example.com', 'instructor'),
('USR007', 2, 'Michael Chen', 'michael.chen@example.com', 'instructor'),
('USR008', 2, 'Sarah Johnson', 'sarah.johnson@example.com', 'instructor'),
